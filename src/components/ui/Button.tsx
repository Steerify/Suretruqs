...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    // Switched from brand-dark to brand-primary to remove the "black" look
    primary: "bg-brand-primary text-white hover:bg-blue-800 focus:ring-brand-primary",
    secondary: "bg-white border border-brand-secondary text-brand-secondary hover:bg-brand-light focus:ring-brand-secondary",
    cta: "bg-brand-orange text-white hover:bg-brand-orangeHover focus:ring-brand-orange",
