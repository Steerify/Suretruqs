      ...
      <div className="space-y-24">
        ...
        <div className="bg-slate-50 rounded-[3rem] p-12 md:p-16 border border-slate-100 flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-2/3">
                ...
                <p className="text-slate-500 font-medium leading-relaxed">For large-scale industrial projects or monthly corporate retainerships, we provide dedicated fleet management services with custom pricing and priority dispatching.</p>
            </div>
