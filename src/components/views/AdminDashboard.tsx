...
import { 
    ...
    CheckCircle2, Clock, MapPin, Package, RefreshCcw, TrendingUp, DollarSign
} from 'lucide-react';
                            ...
                            <tr key={s.id} className="hover:bg-slate-50/50 transition-colors group">
                                <td className="px-8 py-5">
                                    <div className="flex items-center gap-4">
                                        <div className={`w-10 h-10 rounded-xl flex items-center justify-center font-black ${
                                            s.status === ShipmentStatus.PENDING ? 'bg-orange-50 text-brand-orange' : 'bg-blue-50 text-brand-primary'
                                        }`}>
                                            <Package size={18} />
                                        </div>
                                        <div>
                                ...
                                <td className="px-8 py-5">
                                    <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-wider border ${
                                        ...
                                        s.status === ShipmentStatus.PENDING ? 'bg-orange-50 text-brand-orange border-orange-100' :
                                        'bg-slate-50 text-slate-600 border-slate-100'
                                    }`}>
                                        {s.status === ShipmentStatus.PENDING && <Clock size={10} className="animate-pulse" />}
                                        {s.status.replace('_', ' ')}
                                    </span>
                                </td>
