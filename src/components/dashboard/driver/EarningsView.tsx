...
const EARNINGS_HISTORY: Transaction[] = [
    { id: 'TX-D01', type: 'CREDIT', amount: 45000, date: '2023-10-25', description: 'Job Earning #TRK-8821', status: 'SUCCESS', reference: 'JOB-8821' },
    { id: 'TX-D02', type: 'DEBIT', amount: 150000, date: '2023-10-22', description: 'Weekly Payout', status: 'SUCCESS', reference: 'PAYOUT-09' },
    { id: 'TX-D03', type: 'CREDIT', amount: 85000, date: '2023-10-20', description: 'Job Earning #TRK-5521', status: 'SUCCESS', reference: 'JOB-5521' },
];

export const EarningsView = ({ payoutDetails, setShowBankModal }: { payoutDetails: any, setShowBankModal: (show: boolean) => void }) => (
           ...
           <div className="lg:col-span-2">
               <div className="bg-white border border-slate-200 rounded-3xl p-8 shadow-lg mb-8 relative overflow-hidden">
                   ...
                   <div className="relative z-10">
                       ...
                       <h3 className="text-5xl font-bold mb-8 text-slate-900">₦75,000<span className="text-2xl text-slate-400 font-normal">.00</span></h3>
