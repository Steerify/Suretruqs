...
const MOCK_NOTIFICATIONS = [
    { id: 1, type: 'success', title: 'Payout Processed', message: 'Your weekly earning of ₦150,000 has been sent to your GTBank account.', time: '2 hours ago', read: false },
    { id: 2, type: 'info', title: 'New Zone Bonus', message: 'Earn 1.5x on all trips to Ikeja this weekend!', time: '5 hours ago', read: false },
    { id: 3, type: 'alert', title: 'Document Expiry', message: 'Your Vehicle License expires in 3 days. Please renew to keep driving.', time: '1 day ago', read: true },
];

export const DriverNotificationPanel = () => (
