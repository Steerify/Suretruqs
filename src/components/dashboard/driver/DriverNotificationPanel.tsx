...
const MOCK_NOTIFICATIONS = [
    { id: 1, type: 'success', title: 'Assignment Accepted', message: 'You accepted shipment TRK-001. Proceed to pickup.', time: '2 hours ago', read: false },
    { id: 2, type: 'info', title: 'New Assignment', message: 'Admin assigned a new shipment. Please respond.', time: '5 hours ago', read: false },
